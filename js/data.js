...
const i18n = {
  es: {
    ...
    "hero.headline": "Diseño que<br><em>conecta,</em><br>interfaces<br>que inspiran.",
    "hero.sub": "Diseñador Gráfico & UX/UI con +5 años de experiencia. Creo identidades visuales, interfaces digitales y experiencias de aprendizaje que comunican con precisión y estilo.",
  ...
  en: {
    ...
    "hero.headline": "Design that<br><em>connects,</em><br>interfaces<br>that inspire.",
    "hero.sub": "Graphic & UX/UI Designer with 5+ years of experience. I create visual identities, digital interfaces and learning experiences that communicate with precision and style.",
